...
<body class="bg-content">
				...
				<div class="px-3">
					<div class="d-flex justify-content-between">
						...
						<div>
							...
							<button class="btn text-uppercase text-white button-student" data-bs-toggle="modal"
								data-bs-target="#myModal">Add new
								student</button>
						...
						<div class="modal-body">
							<form class="p-4" method="POST" action="#">
								...
								<div class="mb-3">
									...
									<input type="number" class="form-control" name="Enroll_Number"
										placeholder="Entre your enroll number">
								</div>
								<div class="mb-3">
									<label class="form-label">Date of admission</label>
									<input type="date" class="form-control" name="Date_of_admission"
										placeholder="Entre Date of admission">
								</div>
	...
	function delete_student(val) {
		var a = document.getElementById('confirma');
		a.href = val;
	}
	</script>
